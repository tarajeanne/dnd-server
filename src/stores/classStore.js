const classStore = [
  {
    ...
    level_ups: {
      ...
      3: {
        archetype: {
          Path: ['Path of the Berserker', 'Path of the Totem Warrior']
        }
      },
      4: {
        asi: [
  ...
  },
  {
    ...
    level_ups: {
      ...
      3: {
        archtype: {
          'Bard College': ['College of Lore', 'College of Valor']
        },
        check_prof: {
          coef: 2,
          skill: ['CHOICE', 'CHOICE']
      ...
      9: {
        skills: {
          'Song of Rest':
            'You can use soothing music or oration to help revitalize your wounded allies during a short rest. If you or any friendly creatures who can hear your performance regain hit points at the end of the short rest by spending one or more Hit Dice, each of those creatures regains an extra 1d8 hit points.'
        }
      },
      10: {
        skills: {
      ...
      13: {
        skills: {
          'Song of Rest':
            'You can use soothing music or oration to help revitalize your wounded allies during a short rest. If you or any friendly creatures who can hear your performance regain hit points at the end of the short rest by spending one or more Hit Dice, each of those creatures regains an extra 1d10 hit points.'
        }
      },
      15: {
        skills: {
      ...
      17: {
        skills: {
          'Song of Rest':
            'You can use soothing music or oration to help revitalize your wounded allies during a short rest. If you or any friendly creatures who can hear your performance regain hit points at the end of the short rest by spending one or more Hit Dice, each of those creatures regains an extra 1d12 hit points.'
        }
      },
  ...
  },
  {
  ...
  },
    {
      id: 4,
      name: 'Druid',
      desc: 'Warriors and spellcasters that draw their power from their devotion and connection to nature',
      other_prof: [],
      languages: [
        {
          name: 'Druidic',
      ...
      equipment:
        'You start with the following equipment, in addition to the equipment granted by your background:. * (*a*) a wooden shield or (*b*) any simple weapon \n* (*a*) a scimitar or (*b*) any simple melee weapon \n* Leather armor, an explorer’s pack, and a druidic focus',
      spellcasting_ability: 'Wisdom',
  ...
  //     equipment:
  //       'You start with the following equipment, in addition to the equipment granted by your background:. * (*a*) chain mail or (*b*) leather armor, longbow, and 20 arrows \n* (*a*) a martial weapon and a shield or (*b*) two martial weapons \n* (*a*) a light crossbow and 20 bolts or (*b*) two handaxes \n* (*a*) a dungeoneer’s pack or (*b*) an explorer’s pack',
  //     table:
  ...
  //     tool_prof: 'Choose one type of artisan’s tools or one musical instrument',
  //     save_prof: 'Strength, Dexterity',
  //     check_prof:
  ...
  //     save_prof: 'Dexterity, Intelligence',
  //     check_prof:
