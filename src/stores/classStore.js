const classStore = [
  ...
  },
  {
    ...
    name: 'Druid',
    desc:
      'Warriors and spellcasters that draw their power from their devotion and connection to nature',
    other_prof: [],
    languages: [
      {
        name: 'Druidic',
    ...
    skills_and_features: [
      {
        ...
        depends_on: 'class',
        desc:
          'You can use Druidic to leave hidden messages. You can automatically spot and decipher such a message while adventuring.'
      }
    ],
    level_ups:
