const raceStore = [
  {
    ...
    name: 'Dwarf',
    desc:
      ' Dwarf TraitsYour dwarf character has an assortment of inborn abilities, part and parcel of dwarven nature.',
    asi: [
      {
        name: 'Constitution',
        variable: false,
  ...
  },
  {
    ...
    name: 'Elf',
    desc:
      ' Elf TraitsYour elf character has a variety of natural abilities, the result of thousands of years of elven refinement.',
    asi: [{
      name: 'Dexterity',
      variable: false,
      depends_on: 'race',
  ...
  },
  {
    ...
    name: 'Human',
    desc:
      ' Human TraitsIt’s hard to make generalizations about humans, but your human character has these traits.',
    asi: [{
      name: 'Strength',
      variable: false,
      depends_on: 'race',
  ...
  },
  {
    ...
    name: 'Dragonborn',
    desc:
      ' Dragonborn TraitsYour draconic heritage manifests in a variety of traits you share with other dragonborn.',
    asi: [{
      name: 'Strength',
      variable: false,
      depends_on: 'race',
